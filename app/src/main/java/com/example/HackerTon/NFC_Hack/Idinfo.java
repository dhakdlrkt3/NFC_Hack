...
public class Idinfo extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        IntentFilter tagfDetected = new IntentFilter(NfcAdapter.ACTION_TAG_DISCOVERED);
        tagfDetected.addCategory(Intent.CATEGORY_DEFAULT);
        writeTagFilters = new IntentFilter[] { tagfDetected };
    }
